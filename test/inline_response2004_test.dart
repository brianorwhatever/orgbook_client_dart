...
void main() {
    var instance = new InlineResponse2004();
  ...
  group('test InlineResponse2004', () {
    ...
    // int firstIndex
    test('to test the property `firstIndex`', () async {
      // TODO
    });

    // int lastIndex
    test('to test the property `lastIndex`', () async {
      // TODO
    });
    ...
    // List<CredentialAutocomplete> results (default value: const [])
