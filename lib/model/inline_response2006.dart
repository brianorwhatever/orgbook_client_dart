...
class InlineResponse2006 {
  ...
  List<CredentialTopicSearch> results = const [];
  ...
  @override
  String toString() {
    return 'InlineResponse2006[total=$total, pageSize=$pageSize, page=$page, firstIndex=$firstIndex, lastIndex=$lastIndex, next=$next, previous=$previous, results=$results, ]';
  }
  ...
  InlineResponse2006.fromJson(Map<String, dynamic> json) {
    ...
    results = (json['results'] == null) ?
      null :
      CredentialTopicSearch.listFromJson(json['results']);
  }
  ...
  static Map<String, InlineResponse2006> mapFromJson(Map<String, dynamic> json) {
    final map = Map<String, InlineResponse2006>();
  ...
  static Map<String, List<InlineResponse2006>> mapListFromJson(Map<String, dynamic> json) {
    final map = Map<String, List<InlineResponse2006>>();
    if (json != null && json.isNotEmpty) {
