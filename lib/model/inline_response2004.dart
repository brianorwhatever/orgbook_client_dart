...
class InlineResponse2004 {
  ...
  List<CredentialAutocomplete> results = const [];
  ...
  @override
  String toString() {
    return 'InlineResponse2004[total=$total, pageSize=$pageSize, page=$page, firstIndex=$firstIndex, lastIndex=$lastIndex, next=$next, previous=$previous, results=$results, ]';
  }
  ...
  InlineResponse2004.fromJson(Map<String, dynamic> json) {
    ...
    results = (json['results'] == null) ?
      null :
      CredentialAutocomplete.listFromJson(json['results']);
  }
  ...
  static Map<String, InlineResponse2004> mapFromJson(Map<String, dynamic> json) {
    final map = Map<String, InlineResponse2004>();
  ...
  static Map<String, List<InlineResponse2004>> mapListFromJson(Map<String, dynamic> json) {
    final map = Map<String, List<InlineResponse2004>>();
    if (json != null && json.isNotEmpty) {
